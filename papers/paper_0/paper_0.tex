...
Using the Planck 2018 best-estimate cosmological parameters~\cite{planck_2018} (TT,TE,EE+lowE+lensing combination, $H_0 = 67.36\;\mathrm{km\,s^{-1}\,Mpc^{-1}}$) and CODATA 2018 fundamental constants, Table~\ref{tab:forward} summarizes the test of Eq. (\ref{eq:stefan}) and the inferred Hubble constant.
...
Several features argue against pure coincidence. First, the match holds with sub-percent precision at the implied $H_0 = 68.15\;\mathrm{km\,s^{-1}\,Mpc^{-1}}$, and to 2.4\% at Planck's $H_0 = 67.36$, despite the two quantities having completely independent observational origins. Second, the predicted $H_0 = 68.15\;\mathrm{km\,s^{-1}\,Mpc^{-1}}$ falls between the Planck and TRGB values~\cite{freedman_2021} and well below the SH0ES determination~\cite{riess_2022}, raising the possibility that it captures the true global expansion rate more accurately than either endpoint of the $H_0$ tension.
